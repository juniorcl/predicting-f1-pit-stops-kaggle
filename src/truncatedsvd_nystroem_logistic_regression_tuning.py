...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/truncatedsvd_nystroem_logistic_regression.log'), 
...
dump_pickle(pipe_tuned, '../models/model_truncatedsvd_nystroem_logistic_regression.pkl')
