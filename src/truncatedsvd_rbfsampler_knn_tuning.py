...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/truncatedsvd_rbfsampler_knn.log'), 
...
best_params = {
    ...
    'tol': 0.00025778778008419526, 
    'gamma': 1.0602714603756325e-06, 
    'n_components': 66, 
    'n_neighbors': 10, 
    'weights': 'uniform', 
    'metric': 'minkowski', 
...
dump_pickle(pipe_tuned, '../models/model_truncatedsvd_rbfsampler_knn.pkl')
